...
@interface IDMPhotoBrowser () {
    ...
    // Toolbar
    UIToolbar *_toolbar;
    UIBarButtonItem *_previousButton, *_nextButton, *_actionButton,*_likeToolButton,*_commentToolButton,*_shareToolButton;
    UIButton *_likeButton, *_commentButton, *_shareButton;
...
- (void)viewDidLoad {
    // View
    self.view.backgroundColor = [UIColor colorWithWhite:(_useWhiteBackgroundColor ? 1 : 0) alpha:1];
    _currentPageIndex = self.selected_idx;
    ...
    _pagingScrollView.exclusiveTouch = YES;
    ...
    // Counter Label
    _counterLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMidX(self.view.frame)-50, 25, 100, 40)];
...
//    baseBtnView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.view.frame) - 40, 150, 40)];
//    baseBtnView.userInteractionEnabled = YES;
//    [self.view addSubview:baseBtnView];
    
    
    
    UIImage *image =  [UIImage imageNamed:@"Frameworks/IDMPhotoBrowser.framework/IDMPhotoBrowser.bundle/images/ic_like_white"];
  ...
  //  btnLike.backgroundColor = [UIColor blackColor];
    //[self.view addSubview:btnLike];
    
    
    [btnLike addTarget:self action:@selector(likeClicked) forControlEvents:UIControlEventTouchUpInside];
   ...
   // btnComment.layer.borderWidth = 1;
    btnComment.layer.borderColor = [UIColor redColor].CGColor;
    [btnComment addTarget:self action:@selector(commentClicked) forControlEvents:UIControlEventTouchUpInside];
  ...
  //  [self.view addSubview:btnComment];
   ...
   // btnShare.layer.borderWidth = 1;
    btnShare.layer.borderColor = [UIColor redColor].CGColor;
   ...
   _likeToolButton = [[UIBarButtonItem alloc] initWithCustomView:btnLike];
...
-(UIImage*)returnImageFromResourceBundle:(NSString*)nameOfImage
{
    ...
    NSBundle *bundle = [NSBundle bundleWithURL:[[NSBundle bundleForClass:[self class]] URLForResource:@"IDMPhotoBrowser" withExtension:@"bundle"]];
    NSString *imagePath = [bundle pathForResource:@"images" ofType:@"png"];
    //  NSString *bundlePath = [bundle pathForResource:@"Resource" ofType:@"bundle"];
    NSString *imageString = [[NSBundle bundleWithPath:imagePath] pathForResource:nameOfImage ofType:@"png"];
    
    UIImage *img = [UIImage imageNamed:nameOfImage inBundle:bundle compatibleWithTraitCollection:nil];
    
    UIImage *retrievedImage = [[UIImage alloc] initWithContentsOfFile: imageString];
    return retrievedImage;
}

-(UIButton *)createButton:(CGRect)frame image:(UIImage *)normalImg selectedImage:(UIImage *)selImage
{
